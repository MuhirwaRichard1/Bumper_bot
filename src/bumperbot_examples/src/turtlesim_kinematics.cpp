...
{
    turtle1_pose_sub_ = nh_.subscribe("/turtle1/pose", 1000, &TurtlesimKinematics::turtle1PoseCallback, this);
    turtle2_pose_sub_ = nh_.subscribe("/turtle2/pose", 1000, &TurtlesimKinematics::turtle2PoseCallback, this);
}
